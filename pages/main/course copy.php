    ...
    <section class="course_description_section">
        ...
        <div class="cds_next_course_info_row">
            ...
            <div class="cds_nearest_group green_sticker">
                ...
                <p class="data_row small_row">Длительность: <?php echo $sch->getDurationWeeks() ?></p>
                <?php echo $sch->getClassesInWeek() != null ? '<p class="data_row small_row">Число занятий в неделю: '.$sch->getClassesInWeek().'</p>' : '' ?>
               <!--  <p class="data_row small_row">Общий объем: <?php echo $sch->durationHours  ?> часов</p> -->
                <h4>Цена</h4>
                <p class="price_row"><?php echo $sch->price ?><?php if(!is_string($sch->price)) echo " грн."; ?></p>
            </div>
