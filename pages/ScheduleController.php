...
class ScheduleController
{
    ...
    public static function schedule($courseId)
    {
        ...
        $schedule = DB::getAll("SELECT shedule.start, modifiers.name as modifier_name, modifiers.id as modifier_id, modifiers.default_hour as modifier_default_hour, courseinfo.price as course_price, courseinfo.days, courseinfo.duration as durationHours FROM courseinfo
JOIN modifiers ON modifiers.id = courseinfo.modifier
