...
class ScheduleController
{
    ...
    public static function all()
    {
        ...
        $schedule = DB::getAll('SELECT shedule.start, course.name as course_name, course.alias as course_alias, modifiers.name as modifier,
    ...
    public static function schedule($courseId)
    {
        ...
        $schedule = DB::getAll("SELECT shedule.start, modifiers.name as modifier_name, courseinfo.price, courseinfo.days, courseinfo.duration as durationHours FROM courseinfo
JOIN modifiers ON modifiers.id = courseinfo.modifier
