<div class="cds_course_intro_wrapper">
    <div class="cds_left_column">
        ...
        <p>Если вы уже достигли довольно-таки высокого уровня <b>профессионализма в программировании</b>, а до вершины своего пути вам осталось немного, то стоит попробовать наш <b>курс «Frontend-продвинутый»</b> и  убедиться, что вскоре благодаря нему вы действительно станете лучшим из лучших!
        </p>
        ...
        <ul>
            ...
            <li>Использовать AJAX для обработки форм.</li>
            <li>Использовать JQuery для более эффективной работы.</li>
            <li>Создавать web проект с помощью фреймворка backbone или использовать анимацию в canvas.</li>
    ...
    <div class="cds_right_column">
        ...
        <p>Вместе с нашими преподавателями у вас будет возможность глубоко изучить JavaScript, jQuery, AJAX.</p>
        <p>Стоит сказать и о том, что Frontend разработчик – это, как известно, эксперт в своем сегменте, который имеет ряд навыков и из смежных областей также. Зачастую, такие эксперты знакомы с HTML и CSS, web-дизайном, а также принципами юзабилити. Ко всему прочему, такие разработчики неплохо ориентируются и в серверных языках и технологиях AJAX. Именно этим специалистом необходимо смотреть на тот или иной проект в общем: и на разметку HTML, и на Javascript, и на PHP. Мы прилагаем максимум усилий, чтобы обучение было не только полезным, но интересным и увлекательным, чтобы вам после завершения занятия хотелось только пойти и выполнить домашнее задание, а после придумать собственный проект.</p>
        <p>Кроме того, что вы отлично проведете время на занятиях, найдете новых друзей, которые также как и вы, стремятся освоить новую, более востребованную профессию, в дополнение к приятному, вы получите и полезный опыт, который будет достойно оценен. Так, к примеру, такие вакансии, как PHP junior middle или Frontend javascript предлагают кандидатом заработную плату 1000$ или 1500$ соответственно. Неужто вы не мечтаете о таком прекрасном карьерном будущем для себя? Наверняка мечтаете! А осуществить такие планы вам  поможет наша команда настоящих профессионалов, которые поделятся всем опытом, помогут, подскажут, научат и дадут толчок. WebCamp – все только для вашего успешного и обеспеченного будущего!</p>
        
    </div>
</div>
<div class="cds_course_program_wrapper">
    <h3 class="program_header">Программа курса «Frontend продвинутый»</h3>
    ...
    <h6>1. Введение в Javascript </h6>
     <ul class="circle_list_img">
        ...
        <li>Тестирование в старых браузерах</li>
     </ul>
     <h6>3. Основы Javascript</h6>
       ...
       <h6>  7. Таймеры</h6>
        ...
        <h6>  9. Объектная модель браузера (BOM)</h6>
                                                     <ul class="circle_list_img">
               <li> Объект Window</li>
        ...
        <h6>  15. Cookies</h6>
         ...
         <h6> 17. Дополнительные темы (по мере успеваемости группы)</h6>
            <ul class="circle_list_img">
               <li> Работа с графикой</li>
               <li> Javascript и HTML5</li>
                <li>Создание графических компонент</li>
                <li>Сжатие Javascript</li>
               <li> Наследование</li>
               <li> Каррирование</li>
               <li> Отладка JS в консоли браузера. Продвинутые методы</li>
               <li> TDD, BDD</li>
               <li> Обзор JS-фреймворков (jquery, dojo)</li>
               <li> Пишем валидный Javascript код (JSLint, JSHint)</li>
               <li> Тестирование возможностей. Modernizr</li>
           </ul>
    </div>
         ...
         <h6>4. Структуры данных</h6>
          <ul class="circle_list_img">
           ...
           <li>   Объекты обертки для элементарных типов данных</li>
             ...
             <h6>8. Регулярные выражения</h6>
             <h6>10. Объектная модель документа (DOM)</h6>
              <ul class="circle_list_img">
           ...
           <h6>12. Внешний вид: стили, прокрутка, координаты</h6>
            <ul class="circle_list_img">
          ...
          <h6>16. Javascript и HTTP. AJAX</h6>
          <ul class="circle_list_img">
            <li> Введение в AJAX</li>
            <li> Объект XMLHttpRequest</li>
            <li>Особенности в IE</li>
            <li> Форматы данных</li>
            <li> Отправка форм</li>
            <li> Длинные опросы (long polling)</li>
            <li> Использование JSONP</li>
            <li> iFRAME для асинхронных запросов</li>
            <li>WebSockets</li>
         </ul>
        </div>
</div>